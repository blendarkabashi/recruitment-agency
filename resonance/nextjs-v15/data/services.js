...
export const services2 = [
  {
    ...
    title: "Custom Developer Hiring",
    text: "Hire the perfect developer based on your specific job description. We source, vet, and match you with top-tier talent tailored to your exact needs.",
    categories: [
  ...
  },
  {
    ...
    text: "Choose from a list of pre-vetted, highly skilled developers who are ready to start immediately—skip the long hiring process and hire with confidence.",
    categories: ["Pre-Vetted Talent", "Fast Hiring", "Tested Engineers"],
    delay: "0.15s",
  ...
  },
  {
    ...
    text: "Need a full team? We assemble high-performing development teams tailored to your project.",
    categories: ["Team Building", "Project-Based Teams", "Scalable Hiring"],
    delay: "0.3s",
    iconColorClass: "color-1",
  },
  {
    id: 4,
    path: "M12 2c-2.761 0-5 2.239-5 5s2.239 5 5 5 5-2.239 5-5-2.239-5-5-5zm0 8c-1.657 0-3-1.343-3-3s1.343-3 3-3 3 1.343 3 3-1.343 3-3 3zm10 10h-1v-4c0-3.309-2.691-6-6-6h-6c-3.309 0-6 2.691-6 6v4h-1c-1.104 0-2 .896-2 2v2h24v-2c0-1.104-.896-2-2-2zm-16-4c0-2.206 1.794-4 4-4h6c2.206 0 4 1.794 4 4v4h-14v-4z",
    title: "Staff Augmentation",
    text: "Scale your team with flexible staffing solutions. Whether short-term or long-term, we provide skilled developers to extend your workforce easily.",
    categories: ["Flexible Hiring", "On-Demand Talent", "Quick Integration"],
    delay: "0.3s",
