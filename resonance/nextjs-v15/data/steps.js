...
export const stepsItems = [
  {
    ...
    description:
      "Share your job description and specific requirements. Whether you need a single developer, a specialized skill set, or an entire team, we’ll tailor the search to your needs.",
    number: "Step 1",
    iconPath:
  ...
  },
  {
    ...
    description:
      "We search our vetted talent pool or source top developers who match your criteria. Every candidate is pre-screened, ensuring they meet your technical and professional requirements.",
    number: "Step 2",
    iconPath:
  ...
  {
    title: "Choose & Hire with Confidence",
    description:
      "We present you with a curated list of highly skilled developers who match your needs. You review, interview, and select the best fit—fast, efficient, and hassle-free.",
    number: "Step 3",
    iconPath:
